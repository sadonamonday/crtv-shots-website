            ...
            <main className="max-w-[900px] mx-auto p-5 pt-32">
                ...
                {userLoggedIn && (
                    <div className="mb-5 text-center">
                        <Link
                            to="/add-testimonial"
                            className="inline-block px-4 py-2 bg-white text-black rounded-lg font-semibold shadow-lg transition-transform transition-colors duration-150 hover:bg-[#06d6a0] hover:-translate-y-0.5"
                        >
                            Add Testimonial
                        </Link>
                    </div>
