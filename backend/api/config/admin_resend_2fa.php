...
$stmt = $con->prepare("SELECT user_id FROM signup WHERE user_email = ? AND is_admin = 1");
...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Your new Admin 2FA verification code';
    $mail->Body = "Your new admin verification code is: <b>$twoFA</b>. It expires in 5 minutes.";
