...
if (isset($_POST['signup'])) {
    ...
    if (empty($errors)) {
        ...
        if ($insert->execute()) {
            $verify_link = "http://localhost/finalyearproject/my-app/backend/config/verify_email.php?token=$token";
...
<form action="signup.php" method="post">
    ...
    <p class="mt-2 text-center">Already have an account? <a href="http://localhost:5173/login" class="text-danger">Login</a></p>
</form>
</div>
